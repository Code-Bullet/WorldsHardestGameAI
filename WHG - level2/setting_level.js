...
function setDots() {
   ...
   dots.push(new Dot(tiles[5][2],tiles[5][7], 0, 1));
   dots.push(new Dot(tiles[6][7],tiles[6][2], 0, -1));
   dots.push(new Dot(tiles[7][2],tiles[7][7], 0, 1));
   dots.push(new Dot(tiles[8][7],tiles[8][2], 0, -1));
   dots.push(new Dot(tiles[9][2],tiles[9][7], 0, 1));
   dots.push(new Dot(tiles[10][7],tiles[10][2], 0, -1));
   dots.push(new Dot(tiles[11][2],tiles[11][7], 0, 1));
   dots.push(new Dot(tiles[12][7],tiles[12][2], 0, -1));
   dots.push(new Dot(tiles[13][2],tiles[13][7], 0, 1));
   dots.push(new Dot(tiles[14][7],tiles[14][2], 0, -1));
   dots.push(new Dot(tiles[15][2],tiles[15][7], 0, 1));
   dots.push(new Dot(tiles[16][7],tiles[16][2], 0, -1));
}


function setSolids() {
  solids.push(new Solid(tiles[1][6],tiles[4][8]));
   solids.push(new Solid(tiles[4][8],tiles[17][8]));
   solids.push(new Solid(tiles[17][6],tiles[20][8]));
   solids.push(new Solid(tiles[20][3],tiles[20][6]));
   solids.push(new Solid(tiles[17][1],tiles[20][3]));
   solids.push(new Solid(tiles[4][1],tiles[17][1]));
   solids.push(new Solid(tiles[1][1],tiles[4][3]));
   solids.push(new Solid(tiles[1][3],tiles[1][6]));
}
